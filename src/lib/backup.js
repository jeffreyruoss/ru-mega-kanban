 ...
 */
export function backupLocalStorage(onSuccess, onError) {
  try {
 ...
 * @returns {string|null} The filename of the created backup, null if failed or skipped
 */
export function attemptAutoBackup(onSuccess, onError, onSkipped) {
  if (shouldCreateBackup()) {
    return backupLocalStorage(onSuccess, onError)
  } else {
...
export function setupAutoBackup(onSuccess, onError, onSkipped) {
  ...
  const autoBackup = () => attemptAutoBackup(onSuccess, onError, onSkipped)
